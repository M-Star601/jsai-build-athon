  ...
  const response = await client.path("/chat/completions").post({
    body: {
      messages: [
        ...
        { role: "user", content: [
            { type: "text", text: "give the html and css code for a website that describes the image below" },
            
            { type: "image_url", image_url: {
                url: getImageDataUrl("C:/Users/vijay/OneDrive/Desktop/jsai_report/vijay/jsai-build-athon/contoso_layout_sketch (1).jpg", "jpg"), details: "low"}}
          ]
        }
      ],
      model: modelName
